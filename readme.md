...
<section>
    ...
    <div>
        ...
        <p>
            É importante destacar a utlização da biblioteca <blockquote>fstream</blockquote>, a qual possui recursos essenciais para a manipulação de arquivos externos. A partir dela, conseguimos ler as linhas, palavras e letras dos inputs utilizados como entrada. Nesse sentido, a ideia geral é percorrer os documentos até o final pegando, simunltaneamente, as linhas que indicam o tamanho das matrizes e as palavras que reperesentam os elementos das matrizes. Isso só é possível pois cada número está separado por espaços. 
        </p>
    </div>
    <div>
