...
<section>
    ...
    <div>
        ...
        <p>
            Seguindo as regras pre-estabelcidas para a execução do caminho guloso, a solução apresentada se baseia na posição relativa do elemento em relação a matriz.
        </p>
        <p>
